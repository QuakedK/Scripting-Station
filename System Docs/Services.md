...
> [!CAUTION]
> If **User Profile Service** is disabled users will no longer be able to successfully sign in or sign out, effectively bricking your system.
...
sc config LocalKdc start=disabled :: Seemingly only exist on 24H2.  
